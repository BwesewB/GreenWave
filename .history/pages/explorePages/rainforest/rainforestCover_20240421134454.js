    ...
    return(
        <>
            <div className={styles.rainforestCoverContainer}>
                <ExplorePageCover src="/images/RainforestBG.png" theTitleText="THE RAINFOREST" theSuppText="Dense tropical ecosystems crucial for biodiversity and climate regulation, threatened by deforestation and climate change."/>
            </div>
        </>
    )
}