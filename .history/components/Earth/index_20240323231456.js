...
export default function Earth() {
  ...
  useEffect(() => {
    ...
    directionalLight.position.set(500, 500, -500); // Lighting from the right side and slightly behind the camera
    ...
    loader.load(
      ...
      function (gltf) {
        ...
        earth.scale.set(0.5, 0.5, 0.5); // Reduce the scale of the earth
        scene.add(earth);
      },
      function (xhr) {
