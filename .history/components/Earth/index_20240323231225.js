...
export default function Earth() {
  ...
  useEffect(() => {
    ...
    camera.position.set(0, 0, 5000); // Set camera position to be farther from the earth
    ...
    controls.dampingFactor = 0.1; // Adjust damping factor (lower value reduces sensitivity)
